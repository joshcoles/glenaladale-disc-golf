...
const Section: React.FC<{
  ...
  caption?: string;
  reverse?: boolean;
}> = ({ title, children, image, imageAlt, caption, reverse = false }) => (
  <div className={`grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start py-14 sm:py-20 border-b border-gray-100 last:border-0 ${reverse ? 'lg:[&>*:first-child]:order-2' : ''}`}>
    <div>
      ...
      <div className="space-y-4 font-serif text-brown-primary text-base leading-relaxed">
        {children}
      </div>
    </div>
    <div>
