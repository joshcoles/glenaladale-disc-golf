	...
	return (
		<>
			<footer className="flex flex-col text-center">
				<div className="bg-brown-primary w-full max-w-7xl py-4 px-4 sm:px-12 lg:px-16 text-beige-primary sm:flex sm:justify-around">
					...
					<ContentSection heading="Address">
						<span>
							257 Blooming Point Rd <br /> Mount Stewart, PE C0A
							1T0
						</span>
					</ContentSection>
