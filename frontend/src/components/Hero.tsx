...
const Hero: React.FC = () => {
	return (
		<section className="relative h-[400px] sm:h-[500px]">
			...
			<div className="absolute inset-0 flex flex-col justify-center items-center px-5 md:px-12 h-full text-center top-0 bottom-0 left-0 right-0">
				...
				<div className="max-w-screen-xl w-full flex flex-col justify-center text-center items-start">
					<div className="relative flex flex-col justify-start max-w-[600px]">
						...
						<p className="z-10 font-serif bg-yellow-primary shadow-brown-offset text-brown-primary p-2 my-4 text-sm md:text-lg">
