			...
			<div className="max-w-screen-xl mx-auto grid gap-8 grid-cols-1 md:grid-cols-2 items-center">
				<div>
					...
					<p className="font-serif text-lg text-gray-700 mb-6">
						...
						favourite destination and community for disc golfers on
						PEI. With holes ranging from technical, short par 3s to
						long, winding par 5s, the course has developed a
						reputation as a "bomber" course with the ability to
						throw drivers along clearly defined wooded fairways.
					</p>
				</div>
				<div>
					<img
