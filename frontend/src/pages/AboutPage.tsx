...
const AboutPage: React.FC = () => {
	const [activeSection, setActiveSection] =
		useState<AboutPageSections>('courseMaps');
		...
		>
			...
			<div className="mb-4">
				...
				<p>
					...
					hand at adding to the list of world-class destination disc
			...
			<div>
				<div className="flex flex-col md:!flex-row md:space-x-8 mt-12 md:mt-16">
					<div className="md:w-1/2">
						...
						<p className="mb-2">
							Andrew is a climate data and policy specialist from
							Charlottetown, working with the government of PEI.
							He has background in GIS and was part of the UPEI
							Climate Lab team that initially built CLIVE (CoastaL
							Impacts Visualization Environment). He started
							playing disc golf around 2013, and quickly became
							interested in travelling around the maritimes
							competing in tournaments.
						</p>
						<p className="mb-2">
							Josh is a software engineer from Charlottetown. He
							began playing disc golf in 2011 when his friend Jeff
							introduced him to Hillcrest Farm, which had just
							opened. He continued to play casually after moving
							to Vancouver and then Toronto, where he became
							interested in the competitive side of Disc Golf. His
							moving back to PEI coincided with the development
							and opening of the course.
						</p>
						<p className="mb-2">
							Patrick is a carpenter from Charlottetown
							specializing in finish carpentry and custom
							cabinetry, which he learned largely while living and
							working in Montreal. Upon moving back to PEI in 2020
							he got a job restoring the Glenaladale schoolhouse,
							which now acts as a central hub for the Glenaladale
							Heritage Trust. After playing a handful of rounds of
							disc golf in the 2010s, he was introduced to the
							sport in 2020 by Josh and like many "covid disc
							golfers", was instantly hooked and quickly caught up
							to more experienced golfers.
						</p>
					</div>
					<div className="mt-4 md:mt-0 md:w-1/2">
						...
						<figcaption className="mb-2 text-xs">
							...
							contributes to maintenance and beutification on a
							regular basis.
						</figcaption>
					</div>
				</div>
				...
				<div className="flex flex-col md:!flex-row-reverse md:space-x-8 md:space-x-reverse mt-12 md:mt-16">
					<div className="md:w-1/2">
						...
						<p className="mb-2">
							Much of the course is built on sections of forest
							which have been harvested as recently as about 2015.
							These sections were slightly easier to develop into
							grassy fairways than the holes which were cut out of
							mature forest. We also have holes that play along
							the edge of an active farmer's field, as well as
							holes which play through an established tree
							plantation with neatly organized rows of trees,
							providing "natural" disc golf fairways.
						</p>
				...
				<div className="flex flex-col md:!flex-row md:space-x-8 mt-12 mb-12 md:mt-16">
					<div className="md:w-1/2">
						...
						<p className="mb-2">
							...
							Having recently been re-introduced to disc golf by
							Josh, Patrick pitched the idea of installing a
							course on the property and brought Josh into the
							conversation. Josh suggested including Andrew,
							mutual friend who had previously expressed interest
							in building a course elsewhere on PEI.
						</p>
	...
	const mapsSection = () => (
		<div
			className={`${activeSection === 'courseMaps' ? 'block' : 'hidden'} max-w-screen-xl mx-auto`}
		>
			<CourseMaps />
		</div>
	);
	...
	const photosSection = () => (
		<section
			className={`${activeSection === 'coursePhotos' ? 'block' : 'hidden'} max-w-screen-xl mx-auto p-4 md:p-8 text-brown-950`}
		>
			<h2 className=" mb-5 text-center text-4xl">Course Photos</h2>
			...
			case 'about':
				return (
					<section className="max-w-screen-xl mx-auto p-4 md:p-8 text-brown-950">
						...
						<div className="mb-4">
							<p className="mb-2">
								Glenaladale Disc Golf Course opened in June of
								2022. It operates as a separate entity from the
								Glenaladale Heritage Trust, from which it leases
								the course's land. The course is grateful to the
								trust for working with them on this ambitious
								project, and for letting them share their space!
							</p>
							<p>
								The course was designed and built by course
								owners / operators Josh Coles, Andrew Clark and
								Patrick Callbeck. The three friends are avid
								disc golfers and wanted to try their hand at
								adding to the list of world-class destination
								disc golf courses on PEI, and to create one with
								a strong community.
							</p>
							<p className="mb-2">
								...
								disc golf. Newer players can enjoy the challenge
								and scale of the course while competitive
								players can challenge themselves on long and
								technical holes.
							</p>
						</div>
							...
							<div className="flex flex-col md:!flex-row md:space-x-8 mt-12 md:mt-16">
								<div className="md:w-1/2">
									...
									<p className="mb-2">
										...
										was instantly hooked and quickly caught
										up to more experienced golfers.
									</p>
								</div>
								<div className="mt-4 md:mt-0 md:w-1/2">
									<img
							...
							<div className="flex flex-col md:!flex-row-reverse md:space-x-8 md:space-x-reverse mt-12 md:mt-16">
								<div className="md:w-1/2">
									...
									<p className="mb-2">
										...
										grassy fairways than the holes which
										were cut out of mature forest. We also
										have holes that play along the edge of
										an active farmer's field, as well as
										holes which play through an established
										tree plantation with neatly organized
										rows of trees, providing "natural" disc
										golf fairways.
									</p>

									<p>
										In September of 2022 the course was hit
										by Hurricane Fiona, which carried winds
										of approximately 150 km/h. While the
										course was not affected as much as
										others, certain holes were changed
										significantly. Hole 13 lost nearly every
										tree on its fairway—over 15 mature birch
										trees. Half of hole 16 was destroyed,
										requiring well over 100 hours of manual
										cleanup. Holes 7 and 18 both lost 100+
										year old mature, prominent pine trees.
										Thousands of trees were lost in total,
										slowing down the progress of the
										course's development as time was
										diverted to cleaning up these affected
										areas.
									</p>
								</div>
								<div className="mt-4 md:mt-0 md:w-1/2">
									...
									/>
									<figcaption className="mb-2 text-xs">
										An aerial view from above hole 5. Holes
										11 and 7 are visible, as is the field
										next to hole 1. In the distance the
										Glenaladale Schoolhouse, Glenaladale
										House itself, and the Tracadie Harbour.
									</figcaption>
								</div>
							</div>
							...
							<div className="flex flex-col md:!flex-row md:space-x-8 mt-12 mb-12 md:mt-16">
								<div className="md:w-1/2">
									...
									<p className="mb-2">
										...
										each year. The long-term plan for the
										course is to continue reinvesting any
										income into the development of the
										course to turn it into a world-class
								...
								<div className="mt-4 md:mt-0 md:w-1/2">
									...
									/>
									<figcaption className="mb-2 text-xs">
										Construction of hole 2's tee pad. This
										frame was built on top of a pile of
										rocks which was found in this location
										while scouting the course's layout. The
										rocks were collected and placed here
										over the years by farmers who farmed the
										field just adjacent to the hole.
									</figcaption>
								</div>
							</div>
						</div>
	...
	return (
		<section className="bg-yellow-primary px-5 flex flex-col flex-grow items-center">
			<div className="max-w-screen-xl flex flex-col items-center">
				...
				{aboutSection()} {mapsSection()} {photosSection()}
			</div>
		</section>
	);
};
