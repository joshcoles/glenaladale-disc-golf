...
const AboutPage: React.FC = () => {
	...
	const faqSection = () => (
		<section
			className={`${activeSection === 'faq' ? 'block' : 'hidden'} max-w-screen-xl mx-auto p-4 md:p-8 text-brown-950 w-full`}
		>
			<FaqSection />
		</section>
	);
		...
		<section className="bg-yellow-primary px-5 flex flex-col flex-grow items-center">
			<div className="max-w-screen-xl flex flex-col items-center w-full">
				<div className=" flex justify-center mt-6 mb-4">
					{(
						['about', 'courseMaps', 'faq'] as AboutPageSections[]
				...
				{aboutSection()} {mapsSection()} {faqSection()}
			</div>
		</section>
	);
};
