				...
				<div className="max-w-screen-xl mx-auto grid gap-8 grid-cols-1 md:grid-cols-2 items-center">
					<div>
						...
						<p className="text-lg text-gray-700 mb-6">
							...
							history, and challenging gameplay. Established in
							2022, the course has quickly become a favorite
							destination for disc golfers of all skill levels.
							Surrounded by scenic woodlands and featuring a
							variety of hole layouts, Glenaladale Disc Golf
							provides an unforgettable experience in the heart of
							Prince Edward Island. Whether you're a local or a
							visitor, join us for a round and enjoy the beauty of
							PEI while improving your game.
						</p>
					</div>
					<div>
						<img
